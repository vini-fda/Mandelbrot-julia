...
# ╔═╡ cf75ff13-67e3-45e9-817e-7b4ab0c2c313
using Symbolics

# ╔═╡ 03454819-2c57-452b-8e5a-5d9c830b68bc
using Images, CUDA

# ╔═╡ 4aabd3cf-ba68-468e-9ff8-dfd617c3ce89
using Interpolations

# ╔═╡ eede168a-1c05-11ec-250d-0bd9cde6d191
md"""
# Mandelbrot Fractal
...
# ╔═╡ 8ca585b2-34ab-4c62-86d8-41c0dfe53d4d
md"""
...
# ╔═╡ f6881202-9995-4d5e-a21b-cc2fe415aebc
md"""
...
# ╔═╡ 35598077-d208-4696-94eb-465de499af0d
function coloring(n)
...
# ╔═╡ a0a9607f-356e-4ce3-9a4d-94a24db008cd
md"""
## Interpolating image-space to world-space
"""

# ╔═╡ 4119e669-b8ed-47b0-aa64-e38b5b6a24d4
md"""
...
j \leftrightarrow x &: (1, w) \xrightarrow{\mathbf{T}_j} (-w/h, w/h)\end{aligned}$$
...
# ╔═╡ 9e5fe43c-cb95-4b1f-8329-41c2fee9c121
@variables w, h, α, i, j, x_0, y_0

# ╔═╡ 121e868d-21d5-4830-be07-0b6ce19f52cc
begin
	# Transform Ti
	Ti = [1 1; h 1] \ [-1, 1] 
	# Transform Tj
...
# ╔═╡ 7d2b340c-1f6e-4ec3-ae16-06399f947695
begin
	# Image dimensions
	...
	interp_expr_sub = substitute.(interp_expr, (
			Dict(w => width, h => height,
				 α => exp(-τ), 
				 x_0 => z0.re, y_0 => z0.im),
			))
end

# ╔═╡ 73e38e33-36e6-4b3d-b0a6-235d02e3fce8
begin
...
# ╔═╡ da82a5d2-266b-4362-b81c-c2d0a3378bd8
begin
	const max_iter = 1024
end

# ╔═╡ 005040ee-5f76-4a42-b070-ad280cf0cc11
md"""
## Calculating the function over a grid of pixels with CUDA
"""

# ╔═╡ 61dc6781-e1e5-4e43-b8e2-6895b24b04f0
...
# ╔═╡ c6e9201d-3db8-4556-84db-45a2b4324da2
begin
...
# ╔═╡ 3534ee6b-28e5-4128-b4be-1b3d12f68d77
img = coloring.(collect(Z))

# ╔═╡ e9392211-8df7-4d01-980f-00409dbc1f31
...
# ╔═╡ 01abaa3b-ac7c-4f69-b306-ff33e5551959
begin
	# Wonky stuff!
	# TODO: FIX Kernel
...
# ╔═╡ 2d5ce2e2-417b-4194-a9ec-8b93aea05a2e
#save("mandelbrot_CUDA_kernel.png", img2)

# ╔═╡ 247febcd-1c2e-49ea-8066-b218367f2c4e
